...
data_dir=/home/workspace/transferlearning/code/DeepDA/SEM_DA
# Office-Home
python main.py --config DANN/DANN.yaml --data_dir $data_dir --src_domain F16X --tgt_domain F16Y | tee DANN_A2C.log
